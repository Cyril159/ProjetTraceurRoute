...
public static class LakeTransformation
{
    ...
    public static float[,] lakeTransformationGaussian(float[,] noiseMapTex, double sigma1, double sigma2)
    {
    ...
    public static float[,] lakeTransformationInverse(float[,] noiseMapTex)
    {
        double x0 = noiseMapTex.GetLength(0) / 2.0d;
        double y0 = noiseMapTex.GetLength(1) / 2.0d;
